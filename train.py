...
def main():
    ...
    log_folder_name = "model_{}_ds_{}_bs_{}_ps_{}_ep_{}_lr_{}_id_{}".format(opt.model_type, opt.data_set, opt.batch_size, opt.patch_size, opt.nEpochs, opt.lr, opt.ex_id)
    ...
    for epoch in range(start_epoch, opt.nEpochs + 1):
        ...
        writer.add_scalar('Learn rate', new_lr, epoch)
        scheduler.step()
