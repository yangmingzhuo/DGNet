...
srun -p aipe --gres=gpu:4 --job-name='DGNet' -w SH-IDC2-172-20-21-216 \
nohup python -m torch.distributed.launch --nproc_per_node=4 --master_port=10325 train_multiDataset_ddp_ours_model.py \
    --gpus=0,1,2,3 \
    --data_set1='renoir_v2' \
    --data_set2='nind' \
    --data_set3='rid2021_v2' \
...
#srun -p aipe --gres=gpu:4 --job-name='DGNet' -w SH-IDC2-172-20-21-72 \
#nohup python -m torch.distributed.launch --nproc_per_node=4 --master_port=10326 train_multiDataset_ddp_ours_model_patch.py \
#    --gpus=0,1,2,3 \
#    --data_set1='renoir_v2' \
#    --data_set2='nind' \
#    --data_set3='rid2021_v2' \
